package com.example.utsmobpro_rizki;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pil = new String[] {"Hello Kitti Sweet Cake", "chocolato cake", "Vanilla Forrest With Cerry", "Strawberry Cake"};
        Gbr = new String[] {
                Integer.toString(R.drawable.hello_kitti),
                Integer.toString(R.drawable.coklat),
                Integer.toString(R.drawable.cerry),
                Integer.toString(R.drawable.strawberry),};
